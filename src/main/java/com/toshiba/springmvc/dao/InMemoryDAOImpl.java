...
public class InMemoryDAOImpl implements AssetDAO {
    ...
    private final List<Asset> assets = Arrays.asList(
      Asset.builder().id(34).name("lenovo").price(55_000).build(),
      Asset.builder().id(35).name("Asus").price(56_000).build(),
      Asset.builder().id(36).name("MacBook-Pro").price(2_00_000).build(),
      Asset.builder().id(37).name("Dell-Inspiron").price(45_000).build(),
      Asset.builder().id(38).name("HP-Elite").price(65_000).build()
    );
